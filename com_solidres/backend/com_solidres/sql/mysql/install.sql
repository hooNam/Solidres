...
CREATE  TABLE IF NOT EXISTS `#__sr_reservations` (
  ...
  `booking_type` TINYINT( 3 ) UNSIGNED NOT NULL DEFAULT  0,
  `total_single_supplement` DECIMAL(12,2) UNSIGNED NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#__sr_extras` (
  ...
  `price_adult` DECIMAL(12,2) UNSIGNED NOT NULL DEFAULT 0,
  `price_child` DECIMAL(12,2) UNSIGNED NOT NULL DEFAULT 0,
  `ordering` INT(11) UNSIGNED NOT NULL DEFAULT 0,
