...
class SolidresViewCurrencies extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		if ($canDo->get('core.admin'))
		{
			...
			{
				JToolBarHelper::custom('currencyExchangeRate.updateExchangeRate', 'upload', 'upload', JText::_('PLG_SOLIDRES_CURRENCY_BTN'), false);
			}
			else
			{
				JToolBarHelper::custom('', 'upload', 'upload', JText::_('SR_REQUIRED_PLG_SOLIDRES_CURRENCY'), false);
			}
			JToolBarHelper::divider();
