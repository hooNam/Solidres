	...
	<table class="table table-striped table-condensed">
		...
		?>
			...
			<tr class="row<?php echo $i % 2; ?>">
				<td>
					<a href="javascript:void(0)" onclick="if (window.parent) window.parent.<?php echo $this->escape($function);?>('<?php echo $item->id; ?>', '<?php echo $this->escape(addslashes($item->name)); ?>', '<?php echo $this->escape($item->category_id); ?>', null, '<?php echo $this->escape(''); ?>', '<?php echo $this->escape($lang2); ?>', null);">
