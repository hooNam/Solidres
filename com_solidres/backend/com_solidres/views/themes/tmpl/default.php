		...
		<div id="sr_panel_right" class="sr_list_view span10">
			...
			if (SRPlugin::isEnabled('hub')) :
				...
				if ($saveOrder):
					...
					JHtml::_('sortablelist.sortable', 'themeList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
				...
				?>
				<form action="<?php echo JRoute::_('index.php?option=com_solidres&view=themes'); ?>" method="post"
					...
					<table class="table table-striped" id="themeList">
						...
						<?php foreach ($this->items as $i => $item) :
							...
							<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->state ?>">
								...
								<td class="center">
									<?php echo JHtml::_('jgrid.published', $item->state, $i, 'themes.', $canChange); ?>
								</td>
							</tr>
						<?php endforeach; ?>
						</tbody>
