...
<div class="wizard wizard-default">
	<ul class="steps">
		<li data-target="#step1" class="active reservation-tab reservation-tab-room <?php echo SR_UI_GRID_COL_4 ?>"><span class="badge badge-info">1</span><?php echo JText::_('SR_STEP_ROOM_AND_RATE') ?><span class="chevron"></span></li>
		<li data-target="#step2" class="reservation-tab reservation-tab-guestinfo <?php echo SR_UI_GRID_COL_4 ?>"><span class="badge">2</span><?php echo JText::_('SR_STEP_GUEST_INFO_AND_PAYMENT') ?><span class="chevron"></span></li>
		<li data-target="#step3" class="reservation-tab reservation-tab-confirmation <?php echo SR_UI_GRID_COL_4 ?>"><span class="badge">3</span><?php echo JText::_('SR_STEP_CONFIRMATION') ?><!--<span class="chevron"></span>--></li>
	</ul>
</div>
...
<div class="step-content">
	...
	<?php if (count($this->item->roomTypes) > 0) : ?>
		...
		foreach($this->item->roomTypes as $roomType ) :
			...
			?>
			<div class="<?php echo SR_UI_GRID_CONTAINER ?> <?php echo $rowCSSClass ?>" id="room_type_row_<?php echo $roomType->id ?>">
						...
						<div class="<?php echo SR_UI_GRID_COL_12 ?>">
							<div class="inner">
								...
								if ((!$isFresh)) :
									...
									?>
										<div class="<?php echo SR_UI_GRID_CONTAINER ?>">
											<div id="tariff-box-<?php echo $roomType->id ?>-<?php echo $tariffKey ?>" data-targetcolor="FF981D" class="<?php echo SR_UI_GRID_COL_12 ?> tariff-box <?php //echo $tariffIsSelected ?>">
												<div class="<?php echo SR_UI_GRID_CONTAINER ?>">
													...
													<div class="<?php echo SR_UI_GRID_COL_4 ?> tariff-value normal_tariff">
														<div class="inner">
												...
												<div class="<?php echo SR_UI_GRID_CONTAINER ?>">
													<div class="<?php echo SR_UI_GRID_COL_12 ?> room-form room-form-<?php echo $roomType->id ?>-<?php echo $tariffKey ?>" id="room-form-<?php echo $roomType->id ?>-<?php echo $tariffKey ?>" style="display: none">
								...
								if ($isFresh && $showTariffs == 1) :
									if (isset($roomType->tariffs) && is_array($roomType->tariffs)) :
										foreach ($roomType->tariffs as $tariff) :
											...
											?>
											<div class="<?php echo SR_UI_GRID_CONTAINER ?>">
												<div id="tariff-box-<?php echo $roomType->id ?>-<?php echo $tariff->id ?>" data-targetcolor="FF981D"  class="<?php echo SR_UI_GRID_COL_12 ?> tariff-box <?php echo $tariffIsSelected ?>">
													<div class="<?php echo SR_UI_GRID_CONTAINER ?>">
														<div
													...
													<div class="<?php echo SR_UI_GRID_CONTAINER ?>">
														<div class="<?php echo SR_UI_GRID_COL_12 ?> room-form room-form-<?php echo $roomType->id ?>-<?php echo $roomType->id ?>" id="room-form-<?php echo $roomType->id ?>-<?php echo $tariff->id ?>" style="display: none">
	...
	<?php if (!$isFresh && count($this->item->roomTypes) > 0) : ?>
